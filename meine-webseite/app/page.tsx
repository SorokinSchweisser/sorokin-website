          ...
          >
            ...
            {modal === "impressum" ? (
              ...
              <div className="space-y-4 text-sm leading-relaxed" style={{ color: "#374151" }}>
                ...
                <section>
                  <h4 className="font-black text-base mb-3" style={{ color: "#111827" }}>1. Datenschutz auf einen Blick</h4>

                  <h5 className="font-bold mb-2 mt-3" style={{ color: "#111827" }}>Allgemeine Hinweise</h5>
                  <p>
                    Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können. Ausführliche Informationen zum Thema Datenschutz entnehmen Sie unserer unter diesem Text aufgeführten Datenschutzerklärung.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Datenerfassung auf dieser Website</h5>

                  <p className="font-semibold mt-2 mb-1" style={{ color: "#111827" }}>Wer ist verantwortlich für die Datenerfassung auf dieser Website?</p>
                  <p>
                    Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten können Sie dem Abschnitt „Hinweis zur Verantwortlichen Stelle" in dieser Datenschutzerklärung entnehmen.
                  </p>

                  <p className="font-semibold mt-3 mb-1" style={{ color: "#111827" }}>Wie erfassen wir Ihre Daten?</p>
                  <p>
                  ...
                  <p className="font-semibold mt-3 mb-1" style={{ color: "#111827" }}>Wofür nutzen wir Ihre Daten?</p>
                  <p>
                    Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden. Sofern über die Website Verträge geschlossen oder angebahnt werden können, werden die übermittelten Daten auch für Vertragsangebote, Bestellungen oder sonstige Auftragsanfragen verarbeitet.
                  </p>

                  <p className="font-semibold mt-3 mb-1" style={{ color: "#111827" }}>Welche Rechte haben Sie bezüglich Ihrer Daten?</p>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Analyse-Tools und Tools von Drittanbietern</h5>
                  <p>
                ...
                {/* ── 2. Hosting ── */}
                <section className="pt-5 mt-5 border-t border-gray-200">
                  <h4 className="font-black text-base mb-3" style={{ color: "#111827" }}>2. Hosting</h4>
                  <p>Wir hosten die Inhalte unserer Website bei folgenden Anbietern:</p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>IONOS</h5>
                  <p>
                    ...
                    <a href="https://www.ionos.de/terms-gtc/terms-privacy" target="_blank" rel="noopener noreferrer" className="hover:underline break-all" style={{ color: "#0770b0" }}>https://www.ionos.de/terms-gtc/terms-privacy</a>.
                  </p>
                  <p className="mt-2">
                    Die Verwendung von IONOS erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst zuverlässigen Darstellung unserer Website. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z. B. Device-Fingerprinting) im Sinne des TDDDG umfasst. Die Einwilligung ist jederzeit widerrufbar.
                  </p>

                  <p className="font-semibold mt-3 mb-1" style={{ color: "#111827" }}>Auftragsverarbeitung</p>
                  <p>
                    Wir haben einen Vertrag über Auftragsverarbeitung (AVV) zur Nutzung des oben genannten Dienstes geschlossen. Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag, der gewährleistet, dass dieser die personenbezogenen Daten unserer Websitebesucher nur nach unseren Weisungen und unter Einhaltung der DSGVO verarbeitet.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Externes Hosting</h5>
                  <p>
                ...
                <section className="pt-5 mt-5 border-t border-gray-200">
                  <h4 className="font-black text-base mb-3" style={{ color: "#111827" }}>3. Allgemeine Hinweise und Pflichtinformationen</h4>

                  <h5 className="font-bold mb-2 mt-3" style={{ color: "#111827" }}>Datenschutz</h5>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Hinweis zur verantwortlichen Stelle</h5>
                  <p>Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:</p>
                  <p className="font-semibold mt-3 mb-1" style={{ color: "#111827" }}>Angaben gemäß § 5 DDG</p>
                  <p>
                    Konstantin Sorokin<br />
                    Mobiler Schweißservice<br />
                    Regerstraße 24<br />
                  ...
                  <p className="mt-2">
                    Telefon:{" "}
                    <a href="tel:015114459165" className="hover:underline" style={{ color: "#0770b0" }}>01511 4459165</a><br />
                    E-Mail:{" "}
                    <a href="mailto:info@sorokinschweisser.de" className="hover:underline" style={{ color: "#0770b0" }}>info@sorokinschweisser.de</a>
                  </p>
                  <p className="mt-2">
                    Verantwortliche Stelle ist die natürliche oder juristische Person, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten (z. B. Namen, E-Mail-Adressen o. Ä.) entscheidet.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Speicherdauer</h5>
                  <p>
                    Soweit innerhalb dieser Datenschutzerklärung keine speziellere Speicherdauer genannt wurde, verbleiben Ihre personenbezogenen Daten bei uns, bis der Zweck für die Datenverarbeitung entfällt. Wenn Sie ein berechtigtes Löschersuchen geltend machen oder eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten gelöscht, sofern wir keine anderen rechtlich zulässigen Gründe für die Speicherung Ihrer personenbezogenen Daten haben (z. B. steuer- oder handelsrechtliche Aufbewahrungsfristen); im letztgenannten Fall erfolgt die Löschung nach Fortfall dieser Gründe.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h5>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Empfänger von personenbezogenen Daten</h5>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Widerruf Ihrer Einwilligung zur Datenverarbeitung</h5>
                  <p>
                    Viele Datenverarbeitungsvorgänge sind nur mit Ihrer ausdrücklichen Einwilligung möglich. Sie können eine bereits erteilte Einwilligung jederzeit widerrufen. Die Rechtmäßigkeit der bis zum Widerruf erfolgten Datenverarbeitung bleibt vom Widerruf unberührt.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h5>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Beschwerderecht bei der zuständigen Aufsichtsbehörde</h5>
                  <p>
                    Im Falle von Verstößen gegen die DSGVO steht den Betroffenen ein Beschwerderecht bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen Aufenthalts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes zu. Das Beschwerderecht besteht unbeschadet anderweitiger verwaltungsrechtlicher oder gerichtlicher Rechtsbehelfe.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Recht auf Datenübertragbarkeit</h5>
                  <p>
                    Sie haben das Recht, Daten, die wir auf Grundlage Ihrer Einwilligung oder in Erfüllung eines Vertrags automatisiert verarbeiten, an sich oder an einen Dritten in einem gängigen, maschinenlesbaren Format aushändigen zu lassen. Sofern Sie die direkte Übertragung der Daten an einen anderen Verantwortlichen verlangen, erfolgt dies nur, soweit es technisch machbar ist.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Auskunft, Berichtigung und Löschung</h5>
                  <p>
                    Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit an uns wenden.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Recht auf Einschränkung der Verarbeitung</h5>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>SSL- bzw. TLS-Verschlüsselung</h5>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Widerspruch gegen Werbe-E-Mails</h5>
                  <p>
                ...
                <section className="pt-5 mt-5 border-t border-gray-200">
                  <h4 className="font-black text-base mb-3" style={{ color: "#111827" }}>4. Datenerfassung auf dieser Website</h4>

                  <h5 className="font-bold mb-2 mt-3" style={{ color: "#111827" }}>Cookies</h5>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Server-Log-Dateien</h5>
                  <p>
                    Der Provider der Seiten erhebt und speichert automatisch Informationen in so genannten Server-Log-Dateien, die Ihr Browser automatisch an uns übermittelt. Dies sind:
                  </p>
                  <ul className="list-disc list-outside ml-5 mt-2 space-y-0.5">
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Kontaktformular</h5>
                  <p>
                  ...
                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Anfrage per E-Mail, Telefon oder Telefax</h5>
                  <p>
                ...
                {/* ── 5. Plugins und Tools ── */}
                <section className="pt-5 mt-5 border-t border-gray-200">
                  <h4 className="font-black text-base mb-3" style={{ color: "#111827" }}>5. Plugins und Tools</h4>

                  <h5 className="font-bold mb-2 mt-3" style={{ color: "#111827" }}>Google Fonts (lokales Hosting)</h5>
                  <p>
                    Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Google Fonts, die von Google bereitgestellt werden. Die Google Fonts sind lokal installiert. Eine Verbindung zu Servern von Google findet dabei nicht statt.
                  </p>
                  <p className="mt-2">
                    Weitere Informationen zu Google Fonts finden Sie unter{" "}
                    <a href="https://developers.google.com/fonts/faq" target="_blank" rel="noopener noreferrer" className="hover:underline break-all" style={{ color: "#0770b0" }}>https://developers.google.com/fonts/faq</a>{" "}
                    und in der Datenschutzerklärung von Google:{" "}
                    <a href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener noreferrer" className="hover:underline break-all" style={{ color: "#0770b0" }}>https://policies.google.com/privacy?hl=de</a>.
                  </p>

                  <h5 className="font-bold mb-2 mt-4" style={{ color: "#111827" }}>Google Maps</h5>
                  <p>
                  ...
                  <p className="mt-2">
                    ...
                    <a href="https://privacy.google.com/businesses/gdprcontrollerterms/" target="_blank" rel="noopener noreferrer" className="hover:underline break-all" style={{ color: "#0770b0" }}>https://privacy.google.com/businesses/gdprcontrollerterms/</a>{" "}
                    und{" "}
                    <a href="https://privacy.google.com/businesses/gdprcontrollerterms/sccs/" target="_blank" rel="noopener noreferrer" className="hover:underline break-all" style={{ color: "#0770b0" }}>https://privacy.google.com/businesses/gdprcontrollerterms/sccs/</a>.
                  </p>
                  <p className="mt-2">
                ...
                <p className="text-xs pt-3 mt-5 border-t border-gray-200" style={{ color: "#9ca3af" }}>
                  Quelle:{" "}
                  <a href="https://www.e-recht24.de" target="_blank" rel="noopener noreferrer" className="hover:underline" style={{ color: "#0770b0" }}>e-recht24.de</a>
                </p>
              </div>
            )}
          </div>
